...
define(["jquery","psl","scripts/tools/tools","scripts/cryptojs/rollups/aes","MVC_Controller_Managerpage","scripts/tools/crypt"], function($,psl,tools,aes,MVC_Controller_Managerpage,crypt) {
	return {
		...
		storeEntry: function(mUrl, mCredential, toggleModal) {
			...
			console.log(mCredential.password);
